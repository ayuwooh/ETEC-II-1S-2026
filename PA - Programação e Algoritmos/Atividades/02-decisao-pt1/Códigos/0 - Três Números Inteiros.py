...
if (
    int1 == int2 == int3
):  # Checa se os números são iguais primeiro, se forem, dá o resultado e não checa mais nada.
    print("Os números são iguais")
else:
    if (
        int1 > int2 and int1 > int3
    ):  # Checa qual é o maior número entre os três números.
    ...
    if (
        int1 < int2 and int1 < int3
    ):  # Checa qual é o menor número entre os três números.
